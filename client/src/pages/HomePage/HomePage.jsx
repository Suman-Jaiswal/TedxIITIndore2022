            ...
            <div className="container py-4">
                <div className="my-4 gradient-border">
                    ...
                    <div className="row justify-content-evenly">
                        <Typography data-aos-duration="1000" data-aos="fade-right" variant="body1" className="text-secondary p-4 col-12 col-md-7">
                        ...
                        <iframe data-aos-duration="1000" data-aos="fade-left" className="p-4 col-12 col-md-4" width="520" height="280" src="https://www.youtube.com/embed/d0NHOpeczUU" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                    </div>
                </div>
                <br />
                <div className="my-4 gradient-border">
                    ...
                    <div className="row justify-content-evenly">
                        <iframe data-aos-duration="1000" data-aos="fade-right" className="p-4 col-12 col-md-4" width="520" height="280" src="https://www.youtube.com/embed/d0NHOpeczUU" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                        <Typography data-aos-duration="1000" data-aos="fade-left" variant="body1" className=" p-4 col-12 col-md-7 text-secondary">
                            In the spirit of ideas worth spreading, TED has created a program called TEDx. TEDx is a program of local, self-organized events that bring people together to share a TED-like experience. Our event is called TEDxIITIndore, where x = independently organized TED event. At our TEDxIITIndore event, TEDTalks video and live speakers will combine to spark deep discussion and connection in a small group. The TED Conference provides general guidance for the TEDx program, but individual TEDx events, including ours, are self-organized.
                        </Typography>
                    </div>
                </div>
                ...
                <div className="container mb-4 gradient-border">
                    ...
                    <div className="text-secondary justify-content-center px-3 row">
                        <div data-aos="zoom-in" data-aos-duration="1000" className="text-center col-12 col-md-4">
